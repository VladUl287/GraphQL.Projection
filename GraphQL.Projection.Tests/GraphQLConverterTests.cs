...
internal sealed class GraphQLConverterTests
{
    ...
    public void Null_Document_Test()
    {
        Assert.Catch(
            ...
            new(() => GraphQLConverter.ConvertToTree<Order>(null, [])));
    }
    ...
    public void Null_Path_Test()
    {
        ...
        Assert.Catch(
            typeof(ArgumentNullException),
            new(() => GraphQLConverter.ConvertToTree<Order>(document, null)));
    }
    ...
    public void Correct_Query_Test()
    {
        ...
        var fields = GraphQLConverter.ConvertToTree<Order>(document, ["order"]);
    ...
    public void Not_Correct_Path_Test()
    {
        ...
        var fields = GraphQLConverter.ConvertToTree<Order>(document, ["book"]);
    ...
    public void Root_Field_Equal_Model_Field_Test()
    {
        ...
        var fields = GraphQLConverter.ConvertToTree<Order>(document, ["id"]);
